(function (angular) {
    ...
    angular.module('FileManagerApp').config(['$translateProvider', function ($translateProvider) {
            ...
            $translateProvider.translations('sv', {
                ...
                files_will_uploaded_to: 'Filer kommer laddas upp till',
                ...
                sure_to_delete: 'Är du säker på att du vill ta bort',
                change_name_move: 'Ändra namn',
                enter_new_name_for: 'Ange nytt namn för',
                extract_item: 'Extrahera item',
                extraction_started: 'Extrahering starad som bakgrundsjobb',
                compression_started: 'Kompresion startad som bakgrundsjobb',
                enter_folder_name_for_extraction: 'Ange målmapp för extrahering av',
                enter_folder_name_for_compression: 'Ange målmapp för kompresion av',
                toggle_fullscreen: 'Växla till fullskärm',
                ...
                folder_name: 'Namn',
                upload: 'Ladda upp',
                change_permissions: 'Ändra behörighet',
                change: 'Ändra',
                details: 'Detaljer',
                icons: 'Ikoner',
                list: 'Lista',
                ...
                actions: 'Åtgärder',
                date: 'Datum',
                no_files_in_folder: 'Inga filer i denna mapp',
                no_folders_in_folder: 'Denna mapp innehåller inga undermappar',
                select_this: 'Välj denna',
                go_back: 'Tillbaka',
                wait: 'Vänta',
                move: 'Flytta',
                download: 'Ladda ner',
                ...
                extract: 'Extrahera',
                compress: 'Komprimera',
                error_invalid_filename: 'Ogiltigt eller upptaget filnamn, ange ett annat',
                error_modifying: 'Ett fel inträffade vid ändring av filen',
                error_deleting: 'Ett fel inträffade vid borttagning',
                error_renaming: 'Ett fel inträffade vid ändring av filnamn',
                error_copying: 'Ett fel inträffade vid kopiering av filen',
                error_compressing: 'Ett fel inträffade vid komprimering',
                error_extracting: 'Ett fel inträffade vid extrahering av filen',
                error_creating_folder: 'Ett fel inträffade vid skapandet av mappen',
                error_getting_content: 'Ett fel inträffade vid hämtning av filinnehållet',
                error_changing_perms: 'Ett fel inträffade vid ändring av behörigheter',
                error_uploading_files: 'Ett fel inträffade vid uppladdning av filen',
